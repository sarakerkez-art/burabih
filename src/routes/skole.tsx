    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="bg-[color:var(--forest)] text-white px-5 sm:px-8 py-14 border-t border-white/10">
        <div className="max-w-5xl mx-auto grid sm:grid-cols-3 gap-10 text-sm">
          ...
          <div className="text-white/80">
            <a href="mailto:contact@bura.earth" className="hover:text-amber-brand transition">contact@bura.earth</a>
            <a href="https://github.com" className="mt-2 flex items-center gap-2 hover:text-amber-brand transition">
